 ...
 * a number, not to admire a form. It is formatted from the amount and currency in
 * window.CONFIG, which is what the server will put in the Sale, so what the payer confirms is
